...
export default function Login() {
  ...
  return (
    <>
    <h4 className='head-Note-Hub'>Welcome to Note-Hub App</h4>

    <div className='container min-vh-100 d-flex justify-content-center align-items-center '>
      <div className='form-container authentication shadow p-5 rounded-4 '>
        ...
        <form className='d-flex flex-column' onSubmit={handleSubmit}>
          ...
          <label htmlFor="email" className='form-label'>Email</label>
            ...
            <input type="email" value={value.email} onChange={hanldeChange} name='email' className="form-control" placeholder="Enter Your Email" aria-label="Email" aria-describedby="basic-addon2"/>
          </div>
